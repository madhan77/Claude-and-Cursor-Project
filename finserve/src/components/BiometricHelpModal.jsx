  ...
  const steps = [
    {
      ...
      icon: <MdFingerprint className="text-6xl text-primary-600 mb-4" />,
    ...
    },
    {
      ...
      icon: <MdEmail className="text-6xl text-primary-600 mb-4" />,
    ...
    },
    {
      ...
      visual: (
        <div className="bg-gray-100 p-4 rounded-lg mt-4 text-center">
          <div className="bg-white p-6 rounded-lg border-2 border-primary-500 inline-block">
            <MdFingerprint className="text-5xl text-primary-600 mx-auto mb-2" />
            ...
            <ul className="space-y-2">
              {currentStepData.details.map((detail, index) => (
                <li key={index} className="flex items-start gap-2 text-sm text-gray-700">
                  <MdCheckCircle className="text-primary-600 mt-0.5 flex-shrink-0" />
                  <span>{detail}</span>
                </li>
              ))}
            </ul>
        ...
        <div className="sticky bottom-0 bg-gray-50 border-t border-gray-200 p-6 flex items-center justify-between">
          ...
          {currentStep < steps.length - 1 ? (
            <button
              ...
              className="px-6 py-2 bg-primary-600 text-white font-semibold hover:bg-primary-700 rounded-lg transition"
            >
              Next
            </button>
          ) : (
